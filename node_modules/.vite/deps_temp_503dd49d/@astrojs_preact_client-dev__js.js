...
` + d(this.__v)), m.call(this, n);
  ...
  var n = false, t = l.__b, o2 = l.diffed, i = l.vnode, l3 = l.__r, f2 = l.__e, y2 = l.__, m2 = l.__h, w = h ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, g = [];
    ...
    if ("function" == typeof e.type && e.type.propTypes) {
      ...
      e.type.__f && delete (l4 = function(n2, e2) {
        ...
        Object.keys(n2).forEach(function(t3) {
          var i3;
          try {
            i3 = n2[t3](e2, t3, o4, "prop", null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
          } catch (n3) {
            i3 = n3;
          }
